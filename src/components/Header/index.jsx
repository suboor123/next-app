...
export default function Header() {
  ...
  const navigation = [
    ...
    },
    {
      name: "Projects",
      href: "/projects",
      icon: <WrenchScrewdriverIcon className="h-6 w-6 object-contain" />,
      isActive: path === "/projects",
    },
    {
      name: "Blogs",
      href: "/blogs",
      icon: <CpuChipIcon className="h-6 w-6 object-contain" />,
      isActive: path === "/blogs",
    },
    {
      name: "LIVE Sessions",
      href: "/live-sessions",
      icon: <SwatchIcon className="h-6 w-6 object-contain" />,
      isActive: path === "/live-sessions",
    },
    {
      name: "Contact",
      href: "/contact",
      icon: <RectangleGroupIcon className="h-6 w-6 object-contain" />,
  ...
  return (
    ...
    >
      {/* <Banner /> */}
      <nav
        className="mx-auto flex max-w-7xl items-center justify-between p-3 lg:py-1 xl:px-0 h-auto md:h-[70px] "
        aria-label="Global"
      >
      ...
      <Dialog
        as="div"
        className="lg:hidden z-[1000] relative"
        open={mobileMenuOpen}
              ...
              <div className="space-y-2 py-6">
                {navigation.map((item) => (
                  <a
                    ...
                    title={item.name}
                    href={item.href}
                    className="-mx-3 block rounded-lg px-3 py-2 text-md font-normal leading-7 text-gray-900 hover:bg-gray-50"
                  >
