            ...
            {showBanner && (
                <div className="relative md:hidden text-black justify-between text-xs isolate flex items-center gap-x-6 overflow-hidden bg-blue-50 px-3 md:px-24 py-2.5">
                    <div className="flex gap-3 items-center">
                        <p>
                            <span className="font-extrabold">20%</span> discount for your first project
                        </p>
                        <a href={'/hire-us'} className="bg-animated text-xs rounded-full px-3 py-1 text-white">
                            Get a Quote
                        </a>
                    </div>
                    <button onClick={closeBanner} type="button" className="-m-3 p-3 focus-visible:outline-offset-[-4px]">
