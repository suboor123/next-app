    ...
    <div className="min-h-screen bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 flex items-center justify-center">
      <div className="bg-white mx-5 bg-opacity-20 backdrop-filter backdrop-blur-lg p-10 rounded-xl shadow-lg max-w-md w-full">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            className="w-full p-3 bg-pink-600 hover:bg-purple-700 text-white font-bold rounded-md focus:outline-none focus:bg-purple-700 transition-all duration-300"
          >
            Login
          </button>
        </form>
