...
const BottomNav = () => {
    ...
    const navItems = [
        ...
        { href: '/blogs', label: 'News feeds', icon: BlogIcon },
        { href: '/projects', label: 'Work', icon: WorkIcon },
        { href: '/live-sessions', label: 'Sessions', icon: SessionIcon },
        { href: '/contact', label: 'Contact', icon: ContactIcon },
    ];

    const getActiveClassName = (currPath) => {
        return path === currPath ? 'border-t-2 border-primary pb-1' : 'text-gray-700 pb-1';
    };
