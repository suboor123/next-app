    ...
    return (
        <div className="absolute md:hidden w-full p-5 bottom-[100px] left-0 transform translate-y-1/2 bg-black bg-opacity-40 text-white flex flex-col items-center justify-center">
            ...
            <p className="text-sm font-light text-center">
                A skilled Web & Mobile Developer with over 4 years of experience in delivering impactful web solutions. Specializing in fullstack development, I design, develop, and test web
                applications across various industries. Discover my projects and skills in modern web technologies.
            </p>
        </div>
    );
};
