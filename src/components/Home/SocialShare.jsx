...
const SocialShare = () => {
    return (
        <div className="flex gap-6 my-6 items-center">
            ...
            <a href="https://wa.me/917011879824?text=Hello%20Suboor%2C%20I%20would%20like%20to%20get%20in%20touch%20with%20you." target="_blank" rel="noopener noreferrer">
                <LazyImg className="h-6 object-cover" src="/assets/whatsapp.png" alt="WhatsApp" />
            </a>
        </div>
    );
};
