...
const RestartBtn = ({ resetQuiz }) => {
    return (
        <div className="bg-white rounded-lg  shadow px-3 py-10 my-3 text-center font-cursive flex items-center justify-center gap-2">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className=" text-pink-400 size-9 ">
                    <path
                        strokeLinecap="round"
