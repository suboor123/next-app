export const INTERNSHIPS = [
    {
        ...
        keywords: 'React internship, React development, JavaScript libraries, Krapton internships',
    ...
    },
    {
        ...
        keywords: 'Angular internship, Angular development, web application framework, Krapton internships',
        ...
        benefits: ['Comprehensive understanding of Angular framework', 'Hands-on experience with Angular CLI and RxJS', 'Real-world project experience', 'Guidance from Angular experts'],
        courseCurriculum: [
    ...
    },
    {
        ...
        keywords: 'Next.js internship, server-side rendering, static site generation, Krapton internships',
    ...
    },
    {
        ...
        description: 'Learn to build scalable and efficient server-side applications with Node.js. Our internship program covers everything from the basics to advanced server-side techniques.',
        keywords: 'Node.js internship, server-side development, Krapton internships',
        longTitle: 'Build Scalable Server-Side Applications with Node.js at Krapton',
        longDescription:
        ...
        headline: 'Excel in Server-Side Development with Node.js Internship at Krapton',
        whyInternshipAtKrapton:
    ...
    },
    {
        ...
        description: 'Master the art of building scalable and maintainable server-side applications with NestJS. Our internship program provides in-depth training and real-world experience.',
        ...
        headline: 'Advance Your Server-Side Skills with NestJS Internship at Krapton',
        whyInternshipAtKrapton:
    ...
    },
    {
        ...
        description: 'Kickstart your iOS development career with our internship program. Learn Swift and Xcode to build modern iOS applications from scratch.',
        ...
        benefits: ['Understanding of Swift and Xcode', 'Experience in building and deploying iOS applications', 'Real-world project experience', 'Mentorship from iOS development experts'],
        courseCurriculum: [
    ...
    },
    {
        ...
        keywords: 'Android internship, Java Kotlin development, Krapton internships',
        ...
        headline: 'Kickstart Your Android Development Career with Krapton’s Internship Program',
        whyInternshipAtKrapton:
    ...
    },
    {
        ...
        keywords: 'web development internship, HTML, CSS, JavaScript, Krapton internships',
        ...
        headline: 'Kickstart Your Web Development Career with Krapton’s Internship Program',
        whyInternshipAtKrapton:
    ...
    },
    {
        ...
        keywords: 'app development internship, React Native, Flutter, Krapton internships',
...
export const INTERNSHIP_PAGE = {
    title: 'Internship Programs at Krapton | Learn React, Angular, Node.js & More',
    description:
    ...
    longTitle: 'Comprehensive Internship Programs at Krapton - Master React, Angular, Node.js, and More',
    longDescription:
    ...
    headline: "Elevate Your IT Skills with Krapton's Professional Internship Programs",
    whyInternshipAtKrapton:
