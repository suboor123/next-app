    ...
    "@graph": [
      {
        ...
        "author": {
          ...
          "name": "Suboor Khan",
          "url": "${BASE}/",
          "sameAs": ["https://github.com/suboor123","https://linkedin.com/in/suboorkhan","https://twitter.com/suboorkhan"]
        },
        "publisher": {
          "@type": "Person",
          "name": "Suboor Khan",
...
<footer class="py-12 border-t dark:border-white/5 border-gray-100" aria-label="Site footer">
  <div class="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
    ...
    <nav aria-label="Social links"><ul class="flex items-center gap-3" role="list">
      ...
      <li><a href="https://linkedin.com/in/suboorkhan" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" class="w-10 h-10 glass rounded-full flex items-center justify-center hover:scale-110 transition-all"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M20.447 20.452H17.01v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.584V9h3.302v1.561h.046c.458-.87 1.579-1.796 3.25-1.796 3.483 0 4.126 2.291 4.126 5.271v6.416z"/></svg></a></li>
